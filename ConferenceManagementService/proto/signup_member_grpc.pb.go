...
const (
	SignupService_SignupMember_FullMethodName = "/proto.SignupService/SignupMember"
)
...
type SignupServiceClient interface {
	SignupMember(ctx context.Context, in *Signup, opts ...grpc.CallOption) (*SignupResponse, error)
}
...
func (c *signupServiceClient) SignupMember(ctx context.Context, in *Signup, opts ...grpc.CallOption) (*SignupResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SignupResponse)
	err := c.cc.Invoke(ctx, SignupService_SignupMember_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SignupServiceServer interface {
	SignupMember(context.Context, *Signup) (*SignupResponse, error)
...
func (UnimplementedSignupServiceServer) SignupMember(context.Context, *Signup) (*SignupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignupMember not implemented")
}
...
func _SignupService_SignupMember_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Signup)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SignupServiceServer).SignupMember(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SignupService_SignupMember_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SignupServiceServer).SignupMember(ctx, req.(*Signup))
	}
...
var SignupService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SignupMember",
			Handler:    _SignupService_SignupMember_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/signup_member.proto",
}
